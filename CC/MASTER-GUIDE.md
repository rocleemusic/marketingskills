...
## 3. The 4-Week Execution Runbook

### Week 1: Foundation & Ops
- [ ] Set up a basic HubSpot CRM (Free/Starter) to track inquiries.
- [ ] Implement the **60-minute response SLA** for all website leads.
- [ ] Review the [Objection Handling Playbook](file:///h:/_CLAUDE/marketingskills/CC/OBJECTION-HANDLING.md) with the production team.

### Week 2: Targeted Outreach
- [ ] Identify 10 "Dream" Ad Agencies or Podcast Networks.
- [ ] Send Sequence 1 (The "Zero Margin for Error" email) to Creative Directors.
- [ ] Log replies and track "Hook Resonance" (Which mention gets the most replies?).

### Week 3: Authority Building
- [ ] Post 2x per week on LinkedIn using the [Social Strategy Templates](file:///h:/_CLAUDE/marketingskills/CC/SOCIAL-STRATEGY.md).
- [ ] Tag partners (e.g., Marvel, HBO) to trigger the "Mirroring" effect.

### Week 4: Site Conversion
- [ ] Update the "Work" category headlines (e.g., "Cinematic Sound for High-Prestige Podcasts").
- [ ] Add the "Talent-in-Town" wedge banner to the bottom of the work grid.

---

## 4. Measuring Success
*   **Leading Indicator**: Number of "Discovery Calls" booked with new agencies.
*   **Lagging Indicator**: Total "Post-Production" contract value signed.
*   **The "North Star"**: The number of high-prestige logos (like Marvel/HBO) added to the roster this year.
